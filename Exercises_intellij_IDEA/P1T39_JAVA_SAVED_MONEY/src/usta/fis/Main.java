...
public class Main {
    ...
    public static int p_user_saved_money(){
        ...
        System.out.println("Iput the saved money in the month (CO)$");
        int v_saved_money = keyboard.nextInt();
        while (v_saved_money<0){
            System.err.println("ERR: Your saved money cannot be less than zero, Input again the saved money (CO)$");
